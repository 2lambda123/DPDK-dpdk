...
#define IXGBE_QUEUE_STAT_COUNTERS                                              \
  (sizeof(hw_stats->qprc) / sizeof(hw_stats->qprc[0]))
...
static int ixgbe_dev_link_update(struct rte_eth_dev *dev, int wait_to_complete);
...
static int ixgbevf_dev_xstats_get(struct rte_eth_dev *dev,
                                  struct rte_eth_xstat *xstats, unsigned n);
static int ixgbe_dev_xstats_get_by_id(struct rte_eth_dev *dev,
...
static int ixgbevf_dev_xstats_get_names(struct rte_eth_dev *dev,
                                        ...
                                        unsigned limit);
static int
ixgbe_dev_xstats_get_names_by_id(struct rte_eth_dev *dev, const uint64_t *ids,
                                 struct rte_eth_xstat_name *xstats_names,
                                 unsigned int limit);
...
static int ixgbe_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id,
                                 int on);
static int ixgbe_vlan_tpid_set(struct rte_eth_dev *dev,
                               enum rte_vlan_type vlan_type, uint16_t tpid_id);
...
static void ixgbe_vlan_hw_strip_disable(struct rte_eth_dev *dev,
                                        uint16_t queue);
...
static void ixgbe_dcb_init(struct ixgbe_hw *hw,
...
static int ixgbevf_vlan_filter_set(struct rte_eth_dev *dev, uint16_t vlan_id,
                                   int on);
...
static int ixgbe_uc_hash_table_set(struct rte_eth_dev *dev,
...
#define IXGBE_CLEAR_HWSTRIP(h, q)                                              \
  do {                                                                         \
    uint32_t idx = (q) / (sizeof((h)->bitmap[0]) * NBBY);                      \
    uint32_t bit = (q) % (sizeof((h)->bitmap[0]) * NBBY);                      \
    (h)->bitmap[idx] &= ~(1 << bit);                                           \
...
#define IXGBE_GET_HWSTRIP(h, q, r)                                             \
  do {                                                                         \
    uint32_t idx = (q) / (sizeof((h)->bitmap[0]) * NBBY);                      \
    uint32_t bit = (q) % (sizeof((h)->bitmap[0]) * NBBY);                      \
...
static const struct rte_ixgbe_xstats_name_off rte_ixgbe_stats_strings[] = {
    ...
    {"rx_size_512_to_1023_packets", offsetof(struct ixgbe_hw_stats, prc1023)},
    {"rx_size_1024_to_max_packets", offsetof(struct ixgbe_hw_stats, prc1522)},
    ...
    {"tx_size_512_to_1023_packets", offsetof(struct ixgbe_hw_stats, ptc1023)},
    {"tx_size_1024_to_max_packets", offsetof(struct ixgbe_hw_stats, ptc1522)},
    ...
    {"flow_director_added_filters",
     offsetof(struct ixgbe_hw_stats, fdirustat_add)},
    {"flow_director_removed_filters",
     offsetof(struct ixgbe_hw_stats, fdirustat_remove)},
    {"flow_director_filter_add_errors",
     offsetof(struct ixgbe_hw_stats, fdirfstat_fadd)},
    {"flow_director_filter_remove_errors",
     offsetof(struct ixgbe_hw_stats, fdirfstat_fremove)},
    {"flow_director_matched_filters",
     offsetof(struct ixgbe_hw_stats, fdirmatch)},
    {"flow_director_missed_filters", offsetof(struct ixgbe_hw_stats, fdirmiss)},

    {"rx_fcoe_crc_errors", offsetof(struct ixgbe_hw_stats, fccrc)},
    {"rx_fcoe_dropped", offsetof(struct ixgbe_hw_stats, fcoerpdc)},
    {"rx_fcoe_mbuf_allocation_errors", offsetof(struct ixgbe_hw_stats, fclast)},
    ...
    {"rx_fcoe_no_direct_data_placement",
     offsetof(struct ixgbe_hw_stats, fcoe_noddp)},
    {"rx_fcoe_no_direct_data_placement_ext_buff",
     offsetof(struct ixgbe_hw_stats, fcoe_noddp_ext_buff)},

    {"tx_flow_control_xon_packets", offsetof(struct ixgbe_hw_stats, lxontxc)},
    {"rx_flow_control_xon_packets", offsetof(struct ixgbe_hw_stats, lxonrxc)},
    {"tx_flow_control_xoff_packets", offsetof(struct ixgbe_hw_stats, lxofftxc)},
    {"rx_flow_control_xoff_packets", offsetof(struct ixgbe_hw_stats, lxoffrxc)},
    {"rx_total_missed_packets", offsetof(struct ixgbe_hw_stats, mpctotal)},
};

#define IXGBE_NB_HW_STATS                                                      \
  (sizeof(rte_ixgbe_stats_strings) / sizeof(rte_ixgbe_stats_strings[0]))

/* MACsec statistics */
static const struct rte_ixgbe_xstats_name_off rte_ixgbe_macsec_strings[] = {
    {"out_pkts_untagged",
     offsetof(struct ixgbe_macsec_stats, out_pkts_untagged)},
    {"out_pkts_encrypted",
     offsetof(struct ixgbe_macsec_stats, out_pkts_encrypted)},
    {"out_pkts_protected",
     offsetof(struct ixgbe_macsec_stats, out_pkts_protected)},
    {"out_octets_encrypted",
     offsetof(struct ixgbe_macsec_stats, out_octets_encrypted)},
    {"out_octets_protected",
     offsetof(struct ixgbe_macsec_stats, out_octets_protected)},
    {"in_pkts_untagged", offsetof(struct ixgbe_macsec_stats, in_pkts_untagged)},
    {"in_pkts_badtag", offsetof(struct ixgbe_macsec_stats, in_pkts_badtag)},
    {"in_pkts_nosci", offsetof(struct ixgbe_macsec_stats, in_pkts_nosci)},
    {"in_pkts_unknownsci",
     offsetof(struct ixgbe_macsec_stats, in_pkts_unknownsci)},
    {"in_octets_decrypted",
     offsetof(struct ixgbe_macsec_stats, in_octets_decrypted)},
    {"in_octets_validated",
     offsetof(struct ixgbe_macsec_stats, in_octets_validated)},
    {"in_pkts_unchecked",
     offsetof(struct ixgbe_macsec_stats, in_pkts_unchecked)},
    {"in_pkts_delayed", offsetof(struct ixgbe_macsec_stats, in_pkts_delayed)},
    {"in_pkts_late", offsetof(struct ixgbe_macsec_stats, in_pkts_late)},
    {"in_pkts_ok", offsetof(struct ixgbe_macsec_stats, in_pkts_ok)},
    {"in_pkts_invalid", offsetof(struct ixgbe_macsec_stats, in_pkts_invalid)},
    {"in_pkts_notvalid", offsetof(struct ixgbe_macsec_stats, in_pkts_notvalid)},
    {"in_pkts_unusedsa", offsetof(struct ixgbe_macsec_stats, in_pkts_unusedsa)},
    {"in_pkts_notusingsa",
     offsetof(struct ixgbe_macsec_stats, in_pkts_notusingsa)},
};

#define IXGBE_NB_MACSEC_STATS                                                  \
  (sizeof(rte_ixgbe_macsec_strings) / sizeof(rte_ixgbe_macsec_strings[0]))
...
#define IXGBE_NB_RXQ_PRIO_STATS                                                \
  (sizeof(rte_ixgbe_rxq_strings) / sizeof(rte_ixgbe_rxq_strings[0]))
...
static const struct rte_ixgbe_xstats_name_off rte_ixgbe_txq_strings[] = {
    ...
    {"xon_to_xoff_packets", offsetof(struct ixgbe_hw_stats, pxon2offc)},
};

#define IXGBE_NB_TXQ_PRIO_STATS                                                \
  (sizeof(rte_ixgbe_txq_strings) / sizeof(rte_ixgbe_txq_strings[0]))
...
#define IXGBEVF_NB_XSTATS                                                      \
  (sizeof(rte_ixgbevf_stats_strings) / sizeof(rte_ixgbevf_stats_strings[0]))

/*
 * This function is the same as ixgbe_is_sfp() in base/ixgbe.h.
 */
static inline int ixgbe_is_sfp(struct ixgbe_hw *hw) {
  switch (hw->phy.type) {
...
static inline int32_t ixgbe_pf_reset_hw(struct ixgbe_hw *hw) {
  uint32_t ctrl_ext;
  int32_t status;
...
static inline void ixgbe_enable_intr(struct rte_eth_dev *dev) {
 ...
 */
static void ixgbe_disable_intr(struct ixgbe_hw *hw) {
  PMD_INIT_FUNC_TRACE();
 ...
 */
static void ixgbe_reset_qstat_mappings(struct ixgbe_hw *hw) {
  uint32_t i;
...
static void ixgbe_restore_statistics_mapping(struct rte_eth_dev *dev) {
  struct ixgbe_stat_mapping_registers *stat_mappings =
...
static void ixgbe_dcb_init(struct ixgbe_hw *hw,
  ...
  if (hw->mac.type == ixgbe_mac_X540 || hw->mac.type == ixgbe_mac_X550 ||
      hw->mac.type == ixgbe_mac_X550EM_x ||
      hw->mac.type == ixgbe_mac_X550EM_a) {
 ...
 */
static void ixgbe_swfw_lock_reset(struct ixgbe_hw *hw) {
  uint16_t mask;
...
static void ixgbe_parse_devargs(struct ixgbe_adapter *adapter,
...
static int eth_ixgbe_dev_init(struct rte_eth_dev *eth_dev,
  ...
  ixgbe_parse_devargs(eth_dev->data->dev_private, pci_dev->device.devargs);
  ...
  eth_dev->data->mac_addrs =
      rte_zmalloc("ixgbe", RTE_ETHER_ADDR_LEN * hw->mac.num_rar_entries, 0);
  ...
  eth_dev->data->hash_mac_addrs =
      rte_zmalloc("ixgbe", RTE_ETHER_ADDR_LEN * IXGBE_VMDQ_NUM_UC_MAC, 0);
...
static int ixgbe_fdir_filter_init(struct rte_eth_dev *eth_dev) {
  ...
  snprintf(fdir_hash_name, RTE_HASH_NAMESIZE, "fdir_%s", eth_dev->device->name);
  ...
  fdir_info->hash_map = rte_zmalloc(
      "ixgbe", sizeof(struct ixgbe_fdir_filter *) * IXGBE_MAX_FDIR_FILTER_NUM,
      0);
...
static int ixgbe_l2_tn_filter_init(struct rte_eth_dev *eth_dev) {
  ...
  snprintf(l2_tn_hash_name, RTE_HASH_NAMESIZE, "l2_tn_%s",
           eth_dev->device->name);
  ...
  l2_tn_info->hash_map = rte_zmalloc(
      "ixgbe", sizeof(struct ixgbe_l2_tn_filter *) * IXGBE_MAX_L2_TN_FILTER_NUM,
      0);
...
static void ixgbevf_parse_devargs(struct ixgbe_adapter *adapter,
                                  struct rte_devargs *devargs) {
  struct rte_kvargs *kvlist;
...
static int eth_ixgbevf_dev_init(struct rte_eth_dev *eth_dev) {
  ...
  /* NOTE: review for potential ordering optimization */
  __atomic_clear(&ad->link_thread_running, __ATOMIC_SEQ_CST);
  ixgbevf_parse_devargs(eth_dev->data->dev_private, pci_dev->device.devargs);
  ...
  /* Allocate memory for storing MAC addresses */
  eth_dev->data->mac_addrs =
      rte_zmalloc("ixgbevf", RTE_ETHER_ADDR_LEN * hw->mac.num_rar_entries, 0);
  if (eth_dev->data->mac_addrs == NULL) {
    PMD_INIT_LOG(ERR,
                 "Failed to allocate %u bytes needed to store "
                 "MAC addresses",
...
static int eth_ixgbe_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
  ...
  if (pci_dev->device.devargs) {
    retval = rte_eth_devargs_parse(pci_dev->device.devargs->args, &eth_da, 1);
    if (retval < 0)
      return retval;
  } else
  ...
  retval = rte_eth_dev_create(
      &pci_dev->device, pci_dev->device.name, sizeof(struct ixgbe_adapter),
      eth_dev_pci_specific_init, pci_dev, eth_ixgbe_dev_init, NULL);
  ...
  for (i = 0; i < eth_da.nb_representor_ports; i++) {
    ...
    vfinfo = *IXGBE_DEV_PRIVATE_TO_P_VFDATA(pf_ethdev->data->dev_private);
    if (vfinfo == NULL) {
      PMD_DRV_LOG(ERR, "no virtual functions supported by PF");
      break;
    }
...
static int eth_ixgbe_pci_remove(struct rte_pci_device *pci_dev) {
  ...
  if (rte_eth_dev_is_repr(ethdev))
    return rte_eth_dev_pci_generic_remove(pci_dev, ixgbe_vf_representor_uninit);
  else
...
static int eth_ixgbevf_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
                                 struct rte_pci_device *pci_dev) {
  return rte_eth_dev_pci_generic_probe(pci_dev, sizeof(struct ixgbe_adapter),
...
static int ixgbe_vlan_tpid_set(struct rte_eth_dev *dev,
  ...
  case RTE_ETH_VLAN_TYPE_OUTER:
    if (qinq) {
      ...
      IXGBE_WRITE_REG(hw, IXGBE_EXVET,
                      (uint32_t)tpid << IXGBE_EXVET_VET_EXT_SHIFT);
    } else {
      reg = IXGBE_READ_REG(hw, IXGBE_VLNCTRL);
      reg = (reg & (~IXGBE_VLNCTRL_VET)) | (uint32_t)tpid;
      IXGBE_WRITE_REG(hw, IXGBE_VLNCTRL, reg);
...
static void ixgbe_vlan_hw_extend_enable(struct rte_eth_dev *dev) {
  ...
  if (hw->mac.type == ixgbe_mac_X550 || hw->mac.type == ixgbe_mac_X550EM_x ||
      hw->mac.type == ixgbe_mac_X550EM_a) {
...
static void ixgbe_vmdq_vlan_hw_filter_enable(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int ixgbe_check_vf_rss_rxq_num(struct rte_eth_dev *dev,
                                      uint16_t nb_rx_q) {
...
static int ixgbe_check_mq_mode(struct rte_eth_dev *dev) {
  ...
  if (RTE_ETH_DEV_SRIOV(dev).active != 0) {
    ...
    if (dev_conf->rxmode.mq_mode == RTE_ETH_MQ_RX_VMDQ_DCB) {
      ...
      if (nb_rx_q != IXGBE_VMDQ_DCB_NB_QUEUES) {
        PMD_INIT_LOG(ERR, "VMDQ+DCB, nb_rx_q != %d.", IXGBE_VMDQ_DCB_NB_QUEUES);
        return -EINVAL;
      }
    ...
    if (dev_conf->txmode.mq_mode == RTE_ETH_MQ_TX_VMDQ_DCB) {
      ...
      if (nb_tx_q != IXGBE_VMDQ_DCB_NB_QUEUES) {
        PMD_INIT_LOG(ERR, "VMDQ+DCB, nb_tx_q != %d", IXGBE_VMDQ_DCB_NB_QUEUES);
        return -EINVAL;
      }
...
static void ixgbe_dev_phy_intr_setup(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbe_interrupt *intr =
      IXGBE_DEV_PRIVATE_TO_INTR(dev->data->dev_private);
  uint32_t gpie;
...
static int ixgbe_flow_ctrl_enable(struct rte_eth_dev *dev,
                                  struct ixgbe_hw *hw) {
  struct ixgbe_adapter *adapter = dev->data->dev_private;
  int err;
  uint32_t mflcn;
    ...
    for (vf = 0; vf < pci_dev->max_vfs; vf++)
      for (idx = 0; idx < IXGBE_MAX_QUEUE_NUM_PER_VF; idx++)
        if (vfinfo[vf].tx_rate[idx] != 0)
          ixgbe_set_vf_rate_limit(dev, vf, vfinfo[vf].tx_rate[idx], 1 << idx);
  }
...
skip_link_setup:
  ...
  if (rte_intr_allow_others(intr_handle)) {
    ...
    rte_intr_callback_unregister(intr_handle, ixgbe_dev_interrupt_handler, dev);
    if (dev->data->dev_conf.intr_conf.lsc != 0)
...
static int ixgbe_dev_stop(struct rte_eth_dev *dev) {
  ...
  if (!rte_intr_allow_others(intr_handle))
    ...
    rte_intr_callback_register(intr_handle, ixgbe_dev_interrupt_handler,
                               (void *)dev);
...
static int ixgbe_dev_close(struct rte_eth_dev *dev) {
  ...
  do {
    ret = rte_intr_callback_unregister(intr_handle, ixgbe_dev_interrupt_handler,
                                       dev);
    if (ret >= 0 || ret == -ENOENT) {
      break;
    } else if (ret != -EAGAIN) {
...
ixgbe_read_stats_registers(struct ixgbe_hw *hw, struct ixgbe_hw_stats *hw_stats,
   ...
   * is disabled.
   */
  int crc_strip = (IXGBE_READ_REG(hw, IXGBE_HLREG0) & IXGBE_HLREG0_RXCRCSTRP);
  ...
  for (i = 0; i < 8; i++) {
    ...
    *total_missed_rx += hw_stats->mpc[i];
    if (hw->mac.type == ixgbe_mac_82598EB) {
      hw_stats->rnbc[i] += IXGBE_READ_REG(hw, IXGBE_RNBC(i));
      hw_stats->pxonrxc[i] += IXGBE_READ_REG(hw, IXGBE_PXONRXC(i));
      hw_stats->pxoffrxc[i] += IXGBE_READ_REG(hw, IXGBE_PXOFFRXC(i));
    } else {
      hw_stats->pxonrxc[i] += IXGBE_READ_REG(hw, IXGBE_PXONRXCNT(i));
      hw_stats->pxoffrxc[i] += IXGBE_READ_REG(hw, IXGBE_PXOFFRXCNT(i));
      hw_stats->pxon2offc[i] += IXGBE_READ_REG(hw, IXGBE_PXON2OFFCNT(i));
    }
    hw_stats->pxontxc[i] += IXGBE_READ_REG(hw, IXGBE_PXONTXC(i));
    hw_stats->pxofftxc[i] += IXGBE_READ_REG(hw, IXGBE_PXOFFTXC(i));
  }
  for (i = 0; i < IXGBE_QUEUE_STAT_COUNTERS; i++) {
    ...
    hw_stats->qbrc[i] += ((uint64_t)IXGBE_READ_REG(hw, IXGBE_QBRC_H(i)) << 32);
    if (crc_strip == 0)
      hw_stats->qbrc[i] -= delta_qprc * RTE_ETHER_CRC_LEN;

    hw_stats->qbtc[i] += IXGBE_READ_REG(hw, IXGBE_QBTC_L(i));
    hw_stats->qbtc[i] += ((uint64_t)IXGBE_READ_REG(hw, IXGBE_QBTC_H(i)) << 32);
  ...
  if (hw->mac.type != ixgbe_mac_82598EB) {
    ...
    hw_stats->fdirustat_remove +=
        (IXGBE_READ_REG(hw, IXGBE_FDIRUSTAT) >> 16) & 0xFFFF;
    hw_stats->fdirfstat_fadd += IXGBE_READ_REG(hw, IXGBE_FDIRFSTAT) & 0xFFFF;
    hw_stats->fdirfstat_fremove +=
        (IXGBE_READ_REG(hw, IXGBE_FDIRFSTAT) >> 16) & 0xFFFF;
  }
  /* MACsec Stats registers */
  macsec_stats->out_pkts_untagged += IXGBE_READ_REG(hw, IXGBE_LSECTXUT);
  macsec_stats->out_pkts_encrypted += IXGBE_READ_REG(hw, IXGBE_LSECTXPKTE);
  macsec_stats->out_pkts_protected += IXGBE_READ_REG(hw, IXGBE_LSECTXPKTP);
  macsec_stats->out_octets_encrypted += IXGBE_READ_REG(hw, IXGBE_LSECTXOCTE);
  macsec_stats->out_octets_protected += IXGBE_READ_REG(hw, IXGBE_LSECTXOCTP);
  ...
  macsec_stats->in_octets_decrypted += IXGBE_READ_REG(hw, IXGBE_LSECRXOCTD);
  macsec_stats->in_octets_validated += IXGBE_READ_REG(hw, IXGBE_LSECRXOCTV);
  ...
  for (i = 0; i < 2; i++) {
    macsec_stats->in_pkts_ok += IXGBE_READ_REG(hw, IXGBE_LSECRXOK(i));
    macsec_stats->in_pkts_invalid += IXGBE_READ_REG(hw, IXGBE_LSECRXINV(i));
    macsec_stats->in_pkts_notvalid += IXGBE_READ_REG(hw, IXGBE_LSECRXNV(i));
  }
  macsec_stats->in_pkts_unusedsa += IXGBE_READ_REG(hw, IXGBE_LSECRXUNSA);
  macsec_stats->in_pkts_notusingsa += IXGBE_READ_REG(hw, IXGBE_LSECRXNUSA);
}
...
static int ixgbe_dev_stats_get(struct rte_eth_dev *dev,
  ...
  struct ixgbe_macsec_stats *macsec_stats =
      IXGBE_DEV_PRIVATE_TO_MACSEC_STATS(dev->data->dev_private);
  ...
  stats->ierrors = hw_stats->crcerrs + hw_stats->mspdc + hw_stats->rlec +
                   hw_stats->ruc + hw_stats->roc + hw_stats->illerrc +
                   hw_stats->errbc + hw_stats->rfc + hw_stats->fccrc +
                   hw_stats->fclast;
...
static unsigned ixgbe_xstats_calc_num(void) {
...
static int ixgbe_dev_xstats_get_names(__rte_unused struct rte_eth_dev *dev,
  ...
  if (xstats_names != NULL) {
    ...
    for (i = 0; i < IXGBE_NB_HW_STATS; i++) {
      strlcpy(xstats_names[count].name, rte_ixgbe_stats_strings[i].name,
    ...
    for (i = 0; i < IXGBE_NB_MACSEC_STATS; i++) {
      strlcpy(xstats_names[count].name, rte_ixgbe_macsec_strings[i].name,
              sizeof(xstats_names[count].name));
      count++;
    }
    ...
    for (stat = 0; stat < IXGBE_NB_RXQ_PRIO_STATS; stat++) {
      for (i = 0; i < IXGBE_NB_RXQ_PRIO_VALUES; i++) {
        snprintf(xstats_names[count].name, sizeof(xstats_names[count].name),
                 "rx_priority%u_%s", i, rte_ixgbe_rxq_strings[stat].name);
        count++;
      }
    }
    ...
    for (stat = 0; stat < IXGBE_NB_TXQ_PRIO_STATS; stat++) {
      for (i = 0; i < IXGBE_NB_TXQ_PRIO_VALUES; i++) {
        snprintf(xstats_names[count].name, sizeof(xstats_names[count].name),
                 "tx_priority%u_%s", i, rte_ixgbe_txq_strings[stat].name);
        count++;
      }
    }
  }
...
ixgbe_dev_xstats_get_names_by_id(struct rte_eth_dev *dev, const uint64_t *ids,
  ...
  ixgbe_dev_xstats_get_names_by_id(dev, NULL, xstats_names_copy, size);
...
static int ixgbevf_dev_xstats_get_names(__rte_unused struct rte_eth_dev *dev,
  ...
  if (xstats_names != NULL)
    for (i = 0; i < IXGBEVF_NB_XSTATS; i++)
      strlcpy(xstats_names[i].name, rte_ixgbevf_stats_strings[i].name,
...
static int ixgbe_dev_xstats_get(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < IXGBE_NB_HW_STATS; i++) {
    xstats[count].value =
        *(uint64_t *)(((char *)hw_stats) + rte_ixgbe_stats_strings[i].offset);
...
static void ixgbevf_update_stats(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbevf_hw_stats *hw_stats =
      (struct ixgbevf_hw_stats *)IXGBE_DEV_PRIVATE_TO_STATS(
          dev->data->dev_private);

  /* Good Rx packet, include VF loopback */
  UPDATE_VF_STAT(IXGBE_VFGPRC, hw_stats->last_vfgprc, hw_stats->vfgprc);
  ...
  UPDATE_VF_STAT(IXGBE_VFGPTC, hw_stats->last_vfgptc, hw_stats->vfgptc);
  ...
  /* Rx Multicst Packet */
  UPDATE_VF_STAT(IXGBE_VFMPRC, hw_stats->last_vfmprc, hw_stats->vfmprc);
}
...
static int ixgbevf_dev_xstats_get(struct rte_eth_dev *dev,
  ...
  for (i = 0; i < IXGBEVF_NB_XSTATS; i++) {
    xstats[i].id = i;
    xstats[i].value =
        *(uint64_t *)(((char *)hw_stats) + rte_ixgbevf_stats_strings[i].offset);
  }
...
static int ixgbe_fw_version_get(struct rte_eth_dev *dev, char *fw_version,
  ...
  if (nvm_ver.oem_valid) {
    snprintf(fw_version, fw_size, "%x.%x.%x", nvm_ver.oem_major,
  ...
  if (nvm_ver.or_valid) {
    snprintf(fw_version, fw_size, "0x%08x, %d.%d.%d", nvm_ver.etk_id,
...
static int ixgbe_dev_info_get(struct rte_eth_dev *dev,
  ...
  dev_info->rx_offload_capa =
      (ixgbe_get_rx_port_offloads(dev) | dev_info->rx_queue_offload_capa);
  ...
  if (hw->mac.type == ixgbe_mac_X540 || hw->mac.type == ixgbe_mac_X540_vf ||
      hw->mac.type == ixgbe_mac_X550 || hw->mac.type == ixgbe_mac_X550_vf) {
...
static int ixgbevf_check_link(struct ixgbe_hw *hw, ixgbe_link_speed *speed,
                              bool *link_up, int wait_to_complete) {
  struct ixgbe_adapter *adapter = container_of(hw, struct ixgbe_adapter, hw);
...
int ixgbe_dev_link_update_share(struct rte_eth_dev *dev, int wait_to_complete,
                                int vf) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbe_adapter *ad = dev->data->dev_private;
  struct rte_eth_link link;
...
static int ixgbe_dev_interrupt_action(struct rte_eth_dev *dev) {
  ...
  if (intr->flags & IXGBE_FLAG_NEED_LINK_UPDATE) {
    ...
    ixgbe_dev_link_status_print(dev);
    if (rte_eal_alarm_set(timeout * 1000, ixgbe_dev_interrupt_delayed_handler,
                          (void *)dev) < 0)
...
static int ixgbe_flow_ctrl_set(struct rte_eth_dev *dev,
  ...
  enum ixgbe_fc_mode rte_fcmode_2_ixgbe_fcmode[] = {
      ixgbe_fc_none, ixgbe_fc_rx_pause, ixgbe_fc_tx_pause, ixgbe_fc_full};
 ...
 */
static int ixgbe_dcb_pfc_enable_generic(struct ixgbe_hw *hw, uint8_t tc_num) {
  int ret_val = 0;
  ...
  mflcn_reg = IXGBE_READ_REG(hw, IXGBE_MFLCN);
  mflcn_reg &=
      ~(IXGBE_MFLCN_RPFCE_SHIFT | IXGBE_MFLCN_RFCE | IXGBE_MFLCN_RPFCE);
  ...
  if ((hw->fc.current_mode & ixgbe_fc_tx_pause) && hw->fc.high_water[tc_num]) {
...
static int ixgbe_dcb_pfc_enable(struct rte_eth_dev *dev, uint8_t tc_num) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int ixgbe_dev_rss_reta_update(struct rte_eth_dev *dev,
  ...
  if (!dev_data->dev_started) {
    PMD_DRV_LOG(ERR, "port %d must be started before rss reta update",
                dev_data->port_id);
    return -EIO;
  }
  ...
  for (i = 0; i < reta_size; i += IXGBE_4_BIT_WIDTH) {
    ...
    mask = (uint8_t)((reta_conf[idx].mask >> shift) & IXGBE_4_BIT_MASK);
    if (!mask)
      continue;
    ...
    for (j = 0, reta = 0; j < IXGBE_4_BIT_WIDTH; j++) {
      if (mask & (0x1 << j))
        reta |= reta_conf[idx].reta[shift + j] << (CHAR_BIT * j);
      else
        reta |= r & (IXGBE_8_BIT_MASK << (CHAR_BIT * j));
    }
    ...
    for (j = 0; j < IXGBE_4_BIT_WIDTH; j++) {
      if (mask & (0x1 << j))
        reta_conf[idx].reta[shift + j] =
            ((reta >> (CHAR_BIT * j)) & IXGBE_8_BIT_MASK);
    }
  }
...
static int ixgbevf_dev_close(struct rte_eth_dev *dev) {
  ...
  rte_intr_disable(intr_handle);
  rte_intr_callback_unregister(intr_handle, ixgbevf_dev_interrupt_handler, dev);
...
static void ixgbevf_set_vfta_all(struct rte_eth_dev *dev, bool on) {
  ...
  for (i = 0; i < IXGBE_VFTA_SIZE; i++) {
    ...
    if (vfta) {
      ...
      for (j = 0; j < 32; j++) {
        if (vfta & mask)
          ixgbe_set_vfta(hw, (i << 5) + j, 0, on, false);
        mask <<= 1;
      }
    }
  }
...
static uint32_t ixgbe_uta_vector(struct ixgbe_hw *hw,
...
static int ixgbevf_add_mac_addr(struct rte_eth_dev *dev,
  ...
  if (diag != 0)
    PMD_DRV_LOG(
        ERR, "Unable to add MAC address " RTE_ETHER_ADDR_PRT_FMT " - diag=%d",
...
ixgbe_inject_5tuple_filter(struct rte_eth_dev *dev,
  ...
  sdpqf = (uint32_t)(filter->filter_info.dst_port << IXGBE_SDPQF_DSTPORT_SHIFT);
  sdpqf = sdpqf | (filter->filter_info.src_port & IXGBE_SDPQF_SRCPORT);

  ftqf = (uint32_t)(filter->filter_info.proto & IXGBE_FTQF_PROTOCOL_MASK);
  ftqf |= (uint32_t)((filter->filter_info.priority & IXGBE_FTQF_PRIORITY_MASK)
  ...
  l34timir |= (uint32_t)(filter->queue << IXGBE_L34T_IMIR_QUEUE_SHIFT);
...
int ixgbe_add_del_ntuple_filter(struct rte_eth_dev *dev,
  ...
  filter =
      ixgbe_5tuple_filter_lookup(&filter_info->fivetuple_list, &filter_5tuple);
  if (filter != NULL && add) {
...
int ixgbe_add_del_ethertype_filter(struct rte_eth_dev *dev,
  ...
  if (add) {
    ...
    etqs |= (uint32_t)((filter->queue << IXGBE_ETQS_RX_QUEUE_SHIFT) &
                       IXGBE_ETQS_RX_QUEUE);
    ...
    ret = ixgbe_ethertype_filter_insert(filter_info, &ethertype_filter);
    if (ret < 0) {
...
static int ixgbe_dev_flow_ops_get(__rte_unused struct rte_eth_dev *dev,
                                  const struct rte_flow_ops **ops) {
  *ops = &ixgbe_flow_ops;
  return 0;
}

static u8 *ixgbe_dev_addr_list_itr(__rte_unused struct ixgbe_hw *hw,
...
static uint64_t ixgbe_read_systime_cyclecounter(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  ...
  case ixgbe_mac_X550EM_a:
    ...
    systime_cycles +=
        (uint64_t)IXGBE_READ_REG(hw, IXGBE_SYSTIMH) * NSEC_PER_SEC;
    break;
  default:
    systime_cycles = (uint64_t)IXGBE_READ_REG(hw, IXGBE_SYSTIML);
    systime_cycles |= (uint64_t)IXGBE_READ_REG(hw, IXGBE_SYSTIMH) << 32;
  }

  return systime_cycles;
}

static uint64_t ixgbe_read_rx_tstamp_cyclecounter(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  ...
  default:
    /* RXSTMPL stores ns and RXSTMPH stores seconds. */
    rx_tstamp_cycles = (uint64_t)IXGBE_READ_REG(hw, IXGBE_RXSTMPL);
    rx_tstamp_cycles |= (uint64_t)IXGBE_READ_REG(hw, IXGBE_RXSTMPH) << 32;
  }

  return rx_tstamp_cycles;
}

static uint64_t ixgbe_read_tx_tstamp_cyclecounter(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  ...
  case ixgbe_mac_X550EM_a:
    ...
    tx_tstamp_cycles +=
        (uint64_t)IXGBE_READ_REG(hw, IXGBE_TXSTMPH) * NSEC_PER_SEC;
    break;
  default:
    /* TXSTMPL stores ns and TXSTMPH stores seconds. */
    tx_tstamp_cycles = (uint64_t)IXGBE_READ_REG(hw, IXGBE_TXSTMPL);
    tx_tstamp_cycles |= (uint64_t)IXGBE_READ_REG(hw, IXGBE_TXSTMPH) << 32;
  }

  return tx_tstamp_cycles;
}

static void ixgbe_start_timecounters(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbe_adapter *adapter = dev->data->dev_private;
  struct rte_eth_link link;
  uint32_t incval = 0;
...
static int ixgbe_timesync_enable(struct rte_eth_dev *dev) {
  ...
  IXGBE_WRITE_REG(
      hw, IXGBE_ETQF(IXGBE_ETQF_FILTER_1588),
...
static int ixgbevf_get_reg_length(struct rte_eth_dev *dev __rte_unused) {
  int count = 0;
  int g_ind = 0;
  const struct reg_info *reg_group;
...
static int ixgbe_get_regs(struct rte_eth_dev *dev,
  ...
  if ((regs->length == 0) ||
    ...
    while ((reg_group = reg_set[g_ind++]))
      count += ixgbe_read_regs_group(dev, &data[count], reg_group);
    return 0;
  }
...
static int ixgbe_get_module_info(struct rte_eth_dev *dev,
  ...
  status =
      hw->phy.ops.read_i2c_eeprom(hw, IXGBE_SFF_SFF_8472_COMP, &sff8472_rev);
  if (status != 0)
    return -EIO;

  /* addressing mode is not supported */
  status = hw->phy.ops.read_i2c_eeprom(hw, IXGBE_SFF_SFF_8472_SWAP, &addr_mode);
  if (status != 0)
    return -EIO;
...
static int ixgbe_update_e_tag_eth_type(struct ixgbe_hw *hw,
                                       uint16_t ether_type) {
  uint32_t etag_etype;
...
/* Enable e-tag tunnel */
static int ixgbe_e_tag_enable(struct ixgbe_hw *hw) {
  uint32_t etag_etype;
...
static int ixgbe_e_tag_filter_del(struct rte_eth_dev *dev,
  ...
  for (i = 1; i < rar_entries; i++) {
    ...
    if ((rar_high & IXGBE_RAH_AV) && (rar_high & IXGBE_RAH_ADTYPE) &&
        ((rar_low & IXGBE_RAL_ETAG_FILTER_MASK) == l2_tunnel->tunnel_id)) {
...
static int ixgbe_e_tag_filter_add(struct rte_eth_dev *dev,
                                  struct ixgbe_l2_tunnel_conf *l2_tunnel) {
  int ret = 0;
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  uint32_t i, rar_entries;
...
static inline int ixgbe_remove_l2_tn_filter(struct ixgbe_l2_tn_info *l2_tn_info,
                                            struct ixgbe_l2_tn_key *key) {
  int ret;
  struct ixgbe_l2_tn_filter *l2_tn_filter;
...
int ixgbe_dev_l2_tunnel_filter_add(struct rte_eth_dev *dev,
                                   struct ixgbe_l2_tunnel_conf *l2_tunnel,
                                   bool restore) {
  int ret;
  struct ixgbe_l2_tn_info *l2_tn_info =
  ...
  if (!restore) {
    ...
    node = rte_zmalloc("ixgbe_l2_tn", sizeof(struct ixgbe_l2_tn_filter), 0);
    if (!node)
      return -ENOMEM;

    rte_memcpy(&node->key, &key, sizeof(struct ixgbe_l2_tn_key));
...
int ixgbe_dev_l2_tunnel_filter_del(struct rte_eth_dev *dev,
                                   struct ixgbe_l2_tunnel_conf *l2_tunnel) {
  int ret;
  struct ixgbe_l2_tn_info *l2_tn_info =
      IXGBE_DEV_PRIVATE_TO_L2_TN_INFO(dev->data->dev_private);
...
static int ixgbe_e_tag_forwarding_en_dis(struct rte_eth_dev *dev, bool en) {
  int ret = 0;
  uint32_t ctrl;
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
...
static int ixgbe_update_vxlan_port(struct ixgbe_hw *hw, uint16_t port) {
 ...
 */
static int ixgbe_add_vxlan_port(struct ixgbe_hw *hw, uint16_t port) {
  if (port == 0) {
 ...
 */
static int ixgbe_del_vxlan_port(struct ixgbe_hw *hw, uint16_t port) {
  uint16_t cur_port;
...
static inline void ixgbe_ntuple_filter_restore(struct rte_eth_dev *dev) {
  struct ixgbe_filter_info *filter_info =
      IXGBE_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
...
static inline void ixgbe_ethertype_filter_restore(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbe_filter_info *filter_info =
      IXGBE_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
  int i;
...
/* restore SYN filter */
static inline void ixgbe_syn_filter_restore(struct rte_eth_dev *dev) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  struct ixgbe_filter_info *filter_info =
      IXGBE_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);
  uint32_t synqf;
...
static inline void ixgbe_l2_tn_filter_restore(struct rte_eth_dev *dev) {
  struct ixgbe_l2_tn_info *l2_tn_info =
      IXGBE_DEV_PRIVATE_TO_L2_TN_INFO(dev->data->dev_private);
  struct ixgbe_l2_tn_filter *node;
...
/* restore rss filter */
static inline void ixgbe_rss_filter_restore(struct rte_eth_dev *dev) {
  struct ixgbe_filter_info *filter_info =
      IXGBE_DEV_PRIVATE_TO_FILTER_INFO(dev->data->dev_private);

  if (filter_info->rss_info.conf.queue_num)
    ixgbe_config_rss_filter(dev, &filter_info->rss_info, TRUE);
}
...
void ixgbe_clear_all_ethertype_filter(struct rte_eth_dev *dev) {
  ...
  for (i = 0; i < IXGBE_MAX_ETQF_FILTERS; i++) {
    if (filter_info->ethertype_mask & (1 << i) &&
      ...
      (void)ixgbe_ethertype_filter_remove(filter_info, (uint8_t)i);
...
void ixgbe_dev_macsec_setting_save(
    struct rte_eth_dev *dev, struct ixgbe_macsec_setting *macsec_setting) {
...
void ixgbe_dev_macsec_register_enable(
    struct rte_eth_dev *dev, struct ixgbe_macsec_setting *macsec_setting) {
  struct ixgbe_hw *hw = IXGBE_DEV_PRIVATE_TO_HW(dev->data->dev_private);
  uint32_t ctrl;
  ...
  ctrl |= en ? IXGBE_LSECTXCTRL_AUTH_ENCRYPT : IXGBE_LSECTXCTRL_AUTH;
